  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-500">Configurez l'identité de votre business et vos options</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
            <h3 className="font-bold text-gray-800 border-b border-gray-100 pb-3 mb-4">Informations Générales</h3>
          ...
          <div className="space-y-6 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
            <h3 className="font-bold text-gray-800 border-b border-gray-100 pb-3 mb-4">Logo et Design</h3>
          ...
          <div className="space-y-6 bg-white p-6 rounded-2xl border border-gray-200 shadow-sm md:col-span-2">
            <h3 className="font-bold text-gray-800 border-b border-gray-100 pb-3 mb-4">Finance et Devises</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    className="w-full pl-10 pr-3 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 font-bold"
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white font-black py-4 px-12 rounded-2xl shadow-xl shadow-blue-500/20 hover:bg-blue-700 transition-all transform active:scale-95"
        >
      ...
      {showToast && (
        <div className="fixed bottom-8 right-8 bg-green-600 text-white px-6 py-3 rounded-xl shadow-2xl flex items-center gap-3 animate-in slide-in-from-right duration-300">
